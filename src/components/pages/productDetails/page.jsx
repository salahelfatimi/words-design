            ...
            <div className=" flex flex-col lg:flex-row min-h-screen ">
                ...
                <div className="lg:w-full  p-6 bg-primary flex flex-col justify-center items-center lg:items-start gap-4">
                    ...
                    <div className=" flex flex-col-reverse lg:flex-row gap-4">
                        <button className=" bg-white hover:bg-primary hover:text-white text-lg duration-700 border-2 cursor-pointer border-white font-primary py-2 px-4 rounded-full   text-primary capitalize flex flex-row items-center justify-center gap-2"><ShoppingCart size={20} /> acheter maintenant avec {produit?.price ? new Intl.NumberFormat('de-DE').format(produit.price) * quantite + " dh" : "--"}</button>
                        <button onClick={handleSaveDetails} className=" bg-secondary hover:bg-primary hover:border-white hover:text-white text-lg duration-700 border-2 cursor-pointer border-secondary font-primary py-2 px-4 rounded-full   text-white capitalize flex flex-row items-center justify-center gap-2"><ShoppingCart size={20} /> ajouter a panier  {produit?.price ? new Intl.NumberFormat('de-DE').format(produit.price) * quantite + " dh" : "--"}</button>
                    </div>
