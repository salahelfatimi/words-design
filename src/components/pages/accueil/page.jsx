        ...
        <div>
            ...
            <div className=" relative h-[100vh] bg-white">
                ...
                <div className=" px-1 absolute inset-0 flex flex-col items-center justify-center container mx-auto gap-4">
                    ...
                    <Link href={'/boutique'} className=" bg-primary text-white rounded-full text-lg lg:text-2xl   mb-4 font-primary font-bold  uppercase  hover:bg-secondary hover:text-white py-3 px-6 flex flex-row items-center justify-center gap-2 duration-700 "><Store size={30}/> Voir Boutique </Link>
                </div>
            </div>
            <LogoScroll/>
            <Produit/>
            ...
            <div className=" px-4 flex flex-col lg:flex-row items-center gap-10 justify-center mx-auto container py-10">
                ...
                <div className="lg:w-1/2 space-y-4">
                    <h2 className=" text-3xl lg:text-6xl  mb-4 font-primary font-bold text-primary uppercase ">À propos de art by Warda</h2>
                    ...
                    <h2 className=" font-primary  text-2xl text-primary">Notre Histoire</h2>
                    ...
                    <h2 className=" font-primary  text-2xl text-primary">Nos Produits</h2>
